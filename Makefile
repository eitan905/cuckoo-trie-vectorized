...
LIB_VECTORIZED_SOURCES=main_vectorized.c util.c verify_trie.c random.c atomics.c mt_debug.c
...
libcuckoo_trie_vectorized.so: Makefile ${LIB_DEPS}
	${CC} ${FLAGS} ${OPTIMIZE_FLAGS} -fPIC -shared -march=haswell -mavx2 -DNDEBUG -o $@ ${LIB_VECTORIZED_SOURCES}
