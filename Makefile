LIB_SOURCES=main.c util.c verify_trie.c random.c atomics.c mt_debug.c vectorized_search.c
LIB_DEPS=${LIB_SOURCES} atomics.h config.h cuckoo_trie.h main.h util.h \
					key_object.h cuckoo_trie_internal.h random.h mt_debug.h vectorized_search.h
...
# Add -mavx2 for explicit AVX2 support
